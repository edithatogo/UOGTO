...
- [ ] Task: Build Active Learning, Snowballing, and Equation Parsing Utilities
    ...
    - [ ] Implement table extraction and visual OCR (`scripts/review/parse_table_ocr.py`) to parse visual payoff grids from PDFs
...
- [ ] Task: Formulate formula triangulation script
    ...
    - [ ] Map literature nodes to Wikidata, SUMO, or DOLCE upper ontologies
- [ ] Task: Generate UOGTO coverage reports & RDF patches
    ...
    - [ ] Set up Continuous Integration literature watchdog scheduler in `.github/workflows/review_watchdog.yml`
