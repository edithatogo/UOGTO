...
- [~] Task: Reconcile in-text citations with SourceRight using a text export of the manuscript.
  - SourceRight 0.1.20 executed successfully but detected 0 citation occurrences from the current citation-key text export. Output is preserved in `docs/paper/sourceright-citations.md`.
