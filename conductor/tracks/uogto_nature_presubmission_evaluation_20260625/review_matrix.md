...
First-pass Nature presubmission review executed on 2026-06-25. Manuscript row updated after full article rewrite and manuscript source checks.
...
| Supplement | Nature editorial | 62 | Reviewed | Must-fix | Evidence is rich but needs a coherent supplement package tied to article claims. |
| PowerPoint | Visual communications | 35 | Needs creation | Must-fix | Search found no deck; create a new editorial deck from powerpoint_asset_inventory.md. |
