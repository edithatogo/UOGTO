...
First-pass Nature presubmission review executed on 2026-06-25. Manuscript row updated after full article rewrite and manuscript source checks. Supplement row updated after adding the paper-facing supplement package map and claim-to-artifact table.
