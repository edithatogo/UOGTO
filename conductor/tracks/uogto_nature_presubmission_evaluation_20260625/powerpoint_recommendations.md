...
## Slide-Level Review Template

| Slide | Current Role | Score | Main Defect | Recommendation | Acceptance Criterion |
| --- | --- | ---: | --- | --- | --- |
| Inventory pending |  |  | Locate the current PowerPoint or slide artefact. | Create one row per slide. | Every slide has a role, score, and recommendation. |
