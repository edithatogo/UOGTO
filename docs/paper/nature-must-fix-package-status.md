...
| 4 | Deck polish | implemented-final-polished | `docs/presentation/uogto_nature_presubmission_deck.pptx`; `docs/presentation/uogto_nature_presubmission_deck_scores.md`; `docs/presentation/uogto_nature_presubmission_deck_thumbnails/`; `conductor/archive/uogto_nature_presubmission_evaluation_20260625/powerpoint_recommendations.md` |
| 5 | Figure loops | implemented-loop-1 | `conductor/archive/uogto_nature_presubmission_evaluation_20260625/image_scores.csv`; `conductor/archive/uogto_nature_presubmission_evaluation_20260625/image_scores.md`; `docs/article-hardening/figures/`; `docs/ontology-comparison/figures/` |
