...
- Continue `uogto_comparative_simulation_ontology_mapping_20260624` Phase 9: CI/release documentation integration, final review, and archive readiness, then continue monitoring LOV/OLS, FAIRsharing curator review, Ontobee issue #212, and Bioregistry issue #1999.
