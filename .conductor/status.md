...
- Release preflight, Pixi release-preflight, and the release-assets workflow now require and upload `dist/registry-handoff.json` so registry handoff state is archived with release artifacts.
